    ...
    <div class="accordion-group">
        <div class="accordion-heading">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#menu" href="#collapse1"><i
                    class="icon-chevron-down"></i>&nbsp;微信消息管理</a>
        </div>
        <div id="collapse1" class="accordion-body collapse in">
            <div class="accordion-inner">
                <ul class="nav nav-list">
                    <li><a href="${ctx}/uploadmsg/" target="mainFrame"><i class="icon-heart icon-white"></i>&nbsp;微信消息</a></li>
                    <li><a href="${ctx}/uploadmsg/chooseMsgItem/" target="mainFrame"><i class="icon-heart icon-white"></i>&nbsp;发送消息</a></li>
                    <li><a href="${ctx}/autoreplymsg/" target="mainFrame"><i class="icon-heart icon-white"></i>&nbsp;自动回复消息</a></li>
                </ul>
            </div>
        </div>
    </div>
