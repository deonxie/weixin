...
<head>
    ...
    <link href="${ctxStatic }/bootstrap/2.3.1/css_default/old-bootstrap.min.css"  rel="stylesheet">
    <style type="text/css">
...
<div id="main">
        ...
        <div class="navbar-inner">
            ...
            <div class="nav-collapse">
                <ul id="menu" class="nav">
                    ...
                    <li class="menu"><a class="menu" href="${ctx}/menuList/system1" target="menuFrame">消息管理</a></li>
                    <li class="menu"><a class="menu" href="${ctx}/menuList/system2" target="menuFrame">学生管理</a></li>
    ...
    <div class="container-fluid">
        ...
        <div id="footer" class="row-fluid">
            Copyright &copy; 2012-2014 - Powered By <a href="#" target="_blank">Thinkjoy</a>
        </div>
    </div>
</div>
<script type="text/javascript">
